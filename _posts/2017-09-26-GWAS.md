...
Interesting the discussion on PCA analysis during the class. This kind of subject, eventually, appears in the forums on the internet. A nice (and funny) explanation about this topic was suggested in the following scenario:  
...
[Here](https://stats.stackexchange.com/questions/2691/making-sense-of-principal-component-analysis-eigenvectors-eigenvalues) is how the conversation might go. The author uses graphs to explain the results. 
